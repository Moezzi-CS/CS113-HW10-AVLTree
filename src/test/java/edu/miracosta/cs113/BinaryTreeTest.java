...
public class BinaryTreeTest {
    ...
    public void testGetLeftSubtreeDefault() {
        ...
        assertEquals(
                ...
                "Test getLeftSubtree failed - should return null on new empty tree.");
    }
    ...
    public void testGetLeftSubtreeData() {
        ...
        assertEquals(
                ...
                "Test getLeftSubtree and getData failed - is there a problem with the full constructor?");
    }
    ...
    public void testGetRightSubtreeDefault() {
        ...
        assertEquals(
                ...
                "Test getRightSubtree failed - should return null on new empty tree.");
    }
    ...
    public void testGetRightSubtreeData() {
        ...
        assertEquals(
                ...
                "Test getRightSubtree and getData failed - is there a problem with the full constructor?");
    }
    ...
    public void testIsLeaf() {
        ...
        assertFalse(
                charTree.isLeaf(),
                "Test isLeaf failed - should return false for a tree that is not empty.");

        // Validate that the left child is a leaf.
        assertTrue(
                charTree.getLeftSubtree().isLeaf(), "Test isLeaf failed - should return true for a node without children.");

        // Validate that the right child is not a leaf.
        assertFalse(
                charTree.getRightSubtree().isLeaf(), "Test isLeaf failed - should return false for a tree that is not empty.");
    }
    ...
    public void testEmptyTree() {
        ...
        assertEquals(EMPTY_TREE, strTree.toString(),"Test empty tree with toString failed.");
    }
    ...
    public void testDegenerateTrees() {
        ...
        assert strTree != null;
        assertEquals(DEGENERATE_TREE, strTree.toString(), "Test toString failed - might there be an error within the " +
    ...
    public void testPerfectTree() {
        ...
        assert strTree != null;
        assertEquals(PERFECT_TREE, strTree.toString(),"Test toString failed - might there be an error within the " +
                "readBinaryTree method?");
    }
    ...
    public void testCompleteTree() {
        ...
        assert strTree != null;
        assertEquals(COMPLETE_TREE, strTree.toString(),"Test toString failed - might there be an error within the " +
                "readBinaryTree method?");
    }
    ...
    public void testFullTree() {
        ...
        assert strTree != null;
        assertEquals(FULL_TREE, strTree.toString(),"Test toString failed - might there be an error within the " +
                "readBinaryTree method?");
    }
